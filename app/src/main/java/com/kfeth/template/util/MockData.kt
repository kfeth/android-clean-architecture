...
val mockArticles: List<ArticleEntity> = listOf(
    ArticleEntity(
        ...
        description = "Top Democrats say the Republican refusal to allow a vote to avert a " +
            "federal default is the most powerful argument yet for weakening the Senate’s " +
            "signature procedural weapon.",
        imageUrl = "https://static01.nyt.com/images/2021/10/06/us/politics/06DC-FILIBUSTER-1/" +
            "merlin_195855555_513907d1-4751-4460-a8b1-d838388b9ae9-facebookJumbo.jpg",
    ...
    ArticleEntity(
        ...
        description = "The 2021 iPad Mini is currently on sale at Adorama for \$499, the first " +
            ...
            "the second-gen Apple Pencil, DJI Mavic Air 2, and Amazon’s Fire HD 10.",
        imageUrl = "https://cdn.vox-cdn.com/thumbor/MykHmRnHL6O-9_uzk4V5NVQUf4E=/0x146:2040x1214/" +
            "fit-in/1200x630/cdn.vox-cdn.com/uploads/chorus_asset/" +
            "file/22883440/vpavic_210924_4766_0022_2.jpg",
